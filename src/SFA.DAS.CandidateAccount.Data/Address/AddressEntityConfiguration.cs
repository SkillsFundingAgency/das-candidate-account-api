...
public class AddressEntityConfiguration : IEntityTypeConfiguration<AddressEntity>
{
    public void Configure(EntityTypeBuilder<AddressEntity> builder)
    {
        ...
        builder.Property(x => x.AddressLine3).HasColumnName("AddressLine3").HasColumnType("varchar").HasMaxLength(150);
        builder.Property(x => x.AddressLine4).HasColumnName("AddressLine4").HasColumnType("varchar").HasMaxLength(150);
        builder.Property(x => x.Postcode).HasColumnName("Postcode").HasColumnType("varchar").HasMaxLength(50).IsRequired();
        builder.Property(x => x.Uprn).HasColumnName("Uprn").HasColumnType("varchar").HasMaxLength(150);
