...
public class WhenCallingGetCandidateByMigratedEmail
{
    [Test, MoqAutoData]
    public async Task Then_Mediator_Query_Is_Called_And_Candidate_Returned(
        string email,
        GetCandidateByMigratedEmailQueryResult queryResult,
        [Frozen] Mock<IMediator> mediator,
        [Greedy] CandidateController controller)
    {
        //Arrange
        mediator.Setup(x => x.Send(It.Is<GetCandidateByMigratedEmailQuery>(c => c.Email.Equals(email)), CancellationToken.None))
            .ReturnsAsync(queryResult);
        
        //Act
        var actual = await controller.GetCandidateByMigratedEmail(email) as OkObjectResult;
        ...
        [Greedy] CandidateController controller)
    {
        ...
        //Act
        var actual = await controller.GetCandidateByMigratedEmail(email) as NotFoundResult;
        ...
        [Greedy] CandidateController controller)
    {
        ...
        //Act
        var actual = await controller.GetCandidateByMigratedEmail(email) as StatusCodeResult;
