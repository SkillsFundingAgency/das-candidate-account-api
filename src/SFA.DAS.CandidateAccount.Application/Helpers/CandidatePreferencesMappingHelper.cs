...
using static SFA.DAS.CandidateAccount.Application.CandidatePreferences.Queries.GetCandidatePreferences.GetCandidatePreferencesQueryResult;

namespace SFA.DAS.CandidateAccount.Application.Helpers;
